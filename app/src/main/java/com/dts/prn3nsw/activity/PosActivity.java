...
public class PosActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras != null)
            lines = extras.getStringArrayList("text_to_print");
            what = extras.getInt("what");

        if(lines != null)

        for (int i = 0; i <lines.size(); i++) {
            TextToPrint+=lines.get(i)+"\n";
        }
    ...
    private void initview(){
        container= (RelativeLayout) findViewById(R.id.activity_pos);
                ...
                new UiExecute() {
                    ...
                    public List<byte[]> processDataBeforeSend() {
                        ...
                        try {
                            ...
                            Log.d("Gets_To_Print","Let's see if it works...");
                            //Toast.makeText(PosActivity.this,"PrintText_Called", Toast.LENGTH_LONG).show();
